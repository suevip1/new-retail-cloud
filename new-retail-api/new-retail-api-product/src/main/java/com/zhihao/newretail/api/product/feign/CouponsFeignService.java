...
import com.zhihao.newretail.api.product.fallback.CouponsFeignFallback;
...
@Primary
@FeignClient(name = "new-retail-product", path = "/new-retail-product", fallback = CouponsFeignFallback.class)
